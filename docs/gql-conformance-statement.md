...
Across the whole run zu produced 47 distinct GQLSTATUS values, counted off the replies rather than off a summary, since a value the engine emitted once is the evidence that the machinery behind it works at all.
